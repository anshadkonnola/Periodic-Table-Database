...
--
-- Name: elements symbol_name_unique_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_name_unique_key UNIQUE (symbol, name);
...
--
-- Name: properties atomic_number_reference; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number_reference FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
